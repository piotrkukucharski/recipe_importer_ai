...
- **Space Management:** Operates by switching the session's active space context. Before each retry-enabled request (GET/POST/PUT), it calls `/api/switch-active-space/{spaceId}/`.
